...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative group w-full min-h-[320px]"
    >
      <div 
        style={{
        ...
        className="absolute inset-0 rounded-[2rem] sm:rounded-[2.5rem] glass border border-white/5 group-hover:border-white/20 transition-colors duration-500 overflow-hidden"
      >
        <div className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
        
        <div className="relative h-full flex flex-col p-6 sm:p-10 justify-between">
          <div 
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-14 md:mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="eyebrow text-primary mb-4">What I Offer</h2>
